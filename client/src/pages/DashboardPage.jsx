...
function DashboardPage() {
  ...
  const handleSellerRequest = async () => {
    try {
      await createSellerRequest(token);
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          ...
          >
            ...
            <p className="text-gray-600 mt-4">View all your rented bikes.</p>
          </Link>
          ...
          {/* RENTALS */}
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h2 className="text-3xl font-bold">🏍️ Rentals</h2>

            <p className="text-gray-600 mt-4">Manage your bike rentals.</p>
          </div>

          {user?.role === "user" && (
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h2 className="text-3xl font-bold">🏪 Become Seller</h2>

              <p className="mt-4 text-gray-600">
                Request access to sell bikes.
              </p>

              <button
                onClick={handleSellerRequest}
                className="mt-5 bg-yellow-400 px-5 py-3 rounded-lg"
              >
